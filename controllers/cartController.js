...
//controller để xử lý AJAX request khi người dùng bấm nút "Thêm vào giỏ hàng" trên website
controller.add = async (req, res) => {
    ...
    if (product && quantity > 0) {
        req.session.cart.add(product, quantity) //gọi phương thức add() từ Cart
    }
